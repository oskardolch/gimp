...
gimp_operation_color_balance_class_init (GimpOperationColorBalanceClass *klass)
{
  ...
  gegl_operation_class_set_key(operation_class, "name", "gimp-color-balance");
  gegl_operation_class_set_key(operation_class, "compat_name", "GIMP Color Balance operation");
