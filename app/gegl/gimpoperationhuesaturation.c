...
gimp_operation_hue_saturation_class_init (GimpOperationHueSaturationClass *klass)
{
  ...
  gegl_operation_class_set_key(operation_class, "name", "gimp-hue-saturation");
  gegl_operation_class_set_key(operation_class, "compat_name", "GIMP Hue-Saturation operation");
